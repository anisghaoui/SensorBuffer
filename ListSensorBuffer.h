...
{	
	std::list< SensorData<T> > buffer;		//Warning prior to C++11 putting < Type <type >> was considered a sentax error as >> is a stream opertor
...
template <typename T>
void ListSensorBuffer<T>::retreive(int sensorId)
{
